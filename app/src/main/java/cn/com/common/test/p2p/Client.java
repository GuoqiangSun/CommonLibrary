...
public class Client {
    ...
    public void start() {
        try {
            ...
            System.out.println("清输入remote ip:");
            String nextIp = scanner.next();
//            System.out.println("输入的ip是:" + nextIp);

            System.out.println("清输入remote port:");
            String nextPort = scanner.next();
//            System.out.println("输入的port是:" + nextPort);
            ...
            //TODO在此输入外网地址和端口
//            String ip = "59.42.206.176";
//            String ip = "192.168.11.179";
//            int port = 8888;
            ...
            System.out.println("本地ip:" + socket.getLocalAddress().getHostAddress());
            System.out.println("本地port：" + localPort);

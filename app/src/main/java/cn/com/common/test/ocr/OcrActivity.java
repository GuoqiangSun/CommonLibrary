package cn.com.common.test.ocr;
 ...
 * Desc: 识别车票接口  @see https://market.aliyun.com/products/57124001/cmapi020096.html?spm=5176.730005.productlist.d_cmapi020096.42dc3524LohetB&innerSource=search_%E7%81%AB%E8%BD%A6%E7%A5%A8%E8%AF%86%E5%88%AB#sku=yuncode1409600000
 */
public class OcrActivity extends AppCompatActivity implements TakePhoto.TakeResultListener, InvokeListener {
    ...
    private void initOcrData() {
        if (FileUtils.isFileExists(CN_FILE) && FileUtils.isFileExists(EN_FILE)) {
            Toast.makeText(getApplicationContext(), "资源文件加载完成", Toast.LENGTH_SHORT).show();
            dismissProgressDialog();
        } else {

            PermissionHelper.requestSinglePermission(getApplicationContext(), new PermissionRequest.OnPermissionResult() {
                @Override
                public boolean onPermissionRequestResult(String permission, boolean granted) {
                    ...
                    ThreadUtils.executeByIo(new ThreadUtils.Task<Object>() {
                        ...
                        public Object doInBackground() throws Throwable {
                            ...
                            Tlog.v(TAG, "copyResult = " + copyResult);
                            return null;
                        }
...
//                bmp = zeroAndOne(bmp); //二值化
            ...
            public void onSuccess(@Nullable String result) {
                ...
                Tlog.v(TAG, "orcLocal result" + result);
            }
    ...
    public void ocrCloud(final String imgFile) {
        ...
        ThreadUtils.executeByIo(new ThreadUtils.Task<String>() {
            ...
            public void onSuccess(@Nullable String result) {
                dismissProgressDialog();
                Tlog.v(TAG, "ocrCloud result" + result);
                if (result != null) {
                    alertText("result", result);
                }
            }
    ...
    public void takeSuccess(TResult result) {
        ...
        Tlog.v(TAG, "takeSuccess " + originalPath);

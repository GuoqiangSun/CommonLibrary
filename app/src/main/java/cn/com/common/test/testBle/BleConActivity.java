...
public class BleConActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBleCon = new BleConnectEngine(this, LooperManager.getInstance().getWorkLooper(), new IBleConCallBack() {
            ...
            @Override
            public void onPeripheralNotify(final String mac, final String uuidStr, final byte[] data) {
            ...
            @Override
            public void onWriteDataFail(final ScanBle mItem) {
    ...
    public void lookService(View v) {
        ...
        SpannableStringBuilder style = BleDataSendProduce.showService(conGatt);

        new AlertDialog.Builder(this)
                .setTitle("服务")// 设置对话框标题
                .setMessage(style).show();// 设置显示的内容
    ...
    public void selectWriteService(View v) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            String s = mAbsBleSend.getUuidStr();
            items[i] = s;
        }
...
//        final String items[] = {"刘德华", "张柏芝", "蔡依林", "张学友"};
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                mBleSend = (AbsBleSend) objects[which];
                Toast.makeText(BleConActivity.this, items[which],

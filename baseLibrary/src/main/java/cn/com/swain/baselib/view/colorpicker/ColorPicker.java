...
package cn.com.swain.baselib.view.colorpicker;
...
//        if (min > XDensityUtils.dp2px(getContext(), 120)) {
//            min = XDensityUtils.dp2px(getContext(), 120);
//        }
        setMeasuredDimension(widthSize, heightSize);

        mColorWheelRadius = dp2px(getContext(), 100);
//        int ii = XDensityUtils.dp2px(getContext(), 35);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        float y = (float) (event.getY() - getHeight() / 2.3);

...
public class MyScanRecord {
    ...
    private static final String TAG = BleScanAuto.TAG;
...
//                Tlog.v(TAG, " fileType:" + fieldType);
            ...
            Tlog.e(TAG, " parse exception ", e);
            Tlog.e(TAG, "unable to parse scan record: " + StrUtil.toString(scanRecord));
    ...
    public String toString() {
        return "MyScanRecord [mAdvertiseFlags=" + mAdvertiseFlags + ", mServiceUuids=" + mServiceUuids
    ...
    private static final class BluetoothUuid {
        ...
        private static ParcelUuid parseUuidFrom(byte[] uuidBytes) {
            ...
            ByteBuffer wrap = ByteBuffer.wrap(uuidBytes).order(ByteOrder.LITTLE_ENDIAN);
            UUID uuid;
            if (length <= UUID_BYTES_16_BIT) {
                uuid = UUID.fromString(String.format(
                        "%08x-0000-1000-8000-00805f9b34fb", wrap.getShort()));
            } else if (length <= UUID_BYTES_32_BIT) {
                uuid = UUID.fromString(String.format(
                        "%08x-0000-1000-8000-00805f9b34fb", wrap.getInt()));
            } else {
    ...
    private static final class BluetoothLeUtils {
